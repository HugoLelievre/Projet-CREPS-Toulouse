...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      textOutput("test"),
      fluidRow(
        column(5,plotOutput("cam_MI")),
        column(5,plotOutput("cam_MI_sport"))
        ),
    )
  )
)
server <- function(input, output) {
  ...
  Indispo_MI <- Indispo[which(Indispo$zone=="MI"),]
  Indispo_MS <- Indispo[which(Indispo$zone=="MS"),]
  Indispo_Rachis <- Indispo[which(Indispo$zone=="Rachis"),]
  ...
  tab.cam <- reactive({
    tab.red = Indispo[which(Indispo$sport == input$Sport),]
  })
  output$test <- renderText({
print(round(dim(Indispo_MI[which(Indispo_MI$duree==1),])[1])*100/dim(Indispo_MI)[1],1)
  })
  output$cam_MI <- renderPlot({
    count.MI <- data.frame(
  class = c("1 semaine ou moins", "1-3 semaines", "Plus de 3 semaines"),
  #n = c(dim(Indispo_MI[which(Indispo_MI$duree==1),][1]),
   #     dim(Indispo_MI[which(Indispo_MI$duree==2),][1]),
    #    dim(Indispo_MI[which(Indispo_MI$duree==3),][1])),
  
  prop = c(round(dim(Indispo_MI[which(Indispo_MI$duree==1),])[1]*100/dim(Indispo_MI)[1],1),
        round(dim(Indispo_MI[which(Indispo_MI$duree==2),])[1]*100/dim(Indispo_MI)[1],1),
        round(dim(Indispo_MI[which(Indispo_MI$duree==3),])[1]*100/dim(Indispo_MI)[1],1))
)
...
ggplot(count.MI, aes(x = "", y = prop, fill = class)) +
  ...
  output$cam_MI_sport <- renderPlot({
    count.MI.sport <- data.frame(
  class = c("1 semaine ou moins", "1-3 semaines", "Plus de 3 semaines"),
  n1 = length(which(Indispo$duree==1 & Indispo$sport==nouveau_sportif()$Sport & Indispo$zone=="MI")),
  n2 = length(which(Indispo$duree==2 & Indispo$sport==nouveau_sportif()$Sport & Indispo$zone=="MI")),
  n3 = length(which(Indispo$duree==3 & Indispo$sport==nouveau_sportif()$Sport & Indispo$zone=="MI")),
  n = c(n1,n2,n3),
  prop = round(n/length(which(Indispo$sport==nouveau_sportif()$Sport & Indispo$zone=="MI"))*100,1)
)
